...
_REQUIRED_PYPDF_VERSION = (6, 18, 1)
_CURRENT_PYPDF_CVES = ("CVE-2026-71852", "CVE-2026-71870", "CVE-2026-84309", "CVE-2026-84310", "CVE-2026-84311")
_LOCKED_PYPDF_REQUIREMENT = '{ name = "pypdf", specifier = ">=6.18.1,<7.0" },'
...
def test_project_declares_current_pypdf_security_floor() -> None:
    ...
    assert '"pypdf>=6.18.1,<7.0"' in project_text
...
def test_current_pypdf_advisories_and_floor_are_documented() -> None:
    ...
    assert "`pypdf>=6.18.1,<7.0`" in changelog
