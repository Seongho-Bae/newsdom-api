...
## 2026-09-12 - Swagger UI UX Improvement
**Learning:** FastAPI에서 swagger_ui_parameters에 "persistAuthorization": True를 추가하면 Swagger UI 페이지를 새로고침해도 인증 자격 증명이 유지되어 개발자 경험(DX)이 향상됩니다.
**Action:** 프로덕션 보안 요구 사항을 준수하기 위해 개발 환경에서만 이 기능이 활성화되도록 확인합니다.
